...
*/
newBrasil = [];
brasil.forEach(function(element,index){
...
var isTodosEstadosComMaisDe7Letras = brasil.every(function(elemento){
    return elemento.length > 7;
});

if(isTodosEstadosComMaisDe7Letras){
...
var isCearaIncluded = brasil.some(function(element){
    return element === 'CE';
});
if(isCearaIncluded){
...
*/
var map = newBrasil.map(function(element){
        element.id++;
