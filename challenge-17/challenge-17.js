...
console.log(text.replace(/Manuel Marques de Sousa/,"Lucas Dimas Cavalcante Lopes"));
...
console.log(
    text.replace(/O Centauro de Luvas/,function(valorRegex){
    return valorRegex.toUpperCase();
    })
);
...
var regexDate = /(\d{2}) de (junho|julho) de (\d+)/g;
...
console.log(
    text.replace(regexDate,function(valorCompleto,dia,mes,ano){
