  ...
  */
  var pessoa1 = { name:"Lucas Dimas", lastName: "Cavalcante Lopes"};
  var pessoa2 = { name:"Debora", lastName: "Scarano Melero"};
  ...
  */
  function sum(){
    return Array.prototype.reduce.call(arguments,function(acumulado,itemAtual){
        return Number(acumulado) + Number(itemAtual);
    });
  }
