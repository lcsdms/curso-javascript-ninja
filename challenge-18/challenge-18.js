...
function formataCPF(cpf){
    var formataCPFRegex = /(\d{3})(\d{3})(\d{3})(\d{2})/g;
    return cpf.replace(formataCPFRegex,function(completo,$1,$2,$3,$4){
        return $1+'.'+$2+'.'+$3+'-'+$4;
    })
}
...
console.log(texto.replace(/(<\w+>)([^<]+)(<\/\w+>)/g, function(completo,$1,$2,$3){
    return $1 + 'O texto dentro da tag ' + $1.replace(/<|>/g,'"') + ' é "' + $2 + '"' + $3 + '\n';
}));
