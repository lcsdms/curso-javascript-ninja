...
*/
carro.mudarCor = function(novaCor){ carro.cor = novaCor };
...
carro.adicionarPessoa = function(quantidade){
	...
	if(quantidade + carro.quantidadePessoas > carro.assentos){
		var quantidadeRestante = carro.assentos - carro.quantidadePessoas;
		var plural;
		quantidadeRestante > 1 ? plural = "s": plural = '';
		return "Só cabem mais " + quantidadeRestante + " pessoa"+plural+"!";
	}
